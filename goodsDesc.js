...
//              console.log(goodsMsg);
            	...
            	<div class="box clearfix">
            		...
            		<div class="pro-choose-main container clearfix">
            			<div class="pro-view span10">
            				<!--img-con fix 设置图片浮动-->
            				<div id="J_img" class="img-con" style="left: 338;margin: 0px;">
            					<div class="ui-wrapper" style="max-width: 100%;">
            						<!--图片-->
            						<div class="ui-viewport" style="width: 100%;overflow: hidden;position: relative;">
            					...
            					<div class="pro-time J_proSeckill">
            						...
            						<div class="pro-time-con">
            							<span class="pro-time-price">
            								...
            								<del>
            									￥
            									<em class="J_seckilPriceDel">${goodsMsg.market_price_min}</em>
            								</del>
            							</span>
            						</div>
            					</div>
           ...
           if(aImages.length == 1){
           	  $(`
           	     	 <img src="${aImages[0]}" alt="" class="slider done" 
       ...
       //创建图片本身
       $(`
       	<img src="${aImages[i]}" alt="" class="slider done" 
